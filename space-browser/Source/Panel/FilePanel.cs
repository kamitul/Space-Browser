...
namespace space_browser.Source.Panel
{
    public class FilePanel : PanelView
    {
        ...
        {
            public FileData(System.Windows.Forms.Panel panel, System.Windows.Forms.ListView listView, params IDataController[] dataGetter) : base(panel, listView, dataGetter)
            {
            }
        }
